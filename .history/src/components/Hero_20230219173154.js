                                ...
                                <ScrollPage page={1}>
                                    <Animator animation={batch(Sticky(37, 60), Fade(), MoveOut())}>
                                        <span className='font-style2'>
                                            ...
                                            Juan Sebastian Suarez Ramirez <br />My purpose is to add value to the world<br /> through my knowledge and skills.
                                        </span>
                                    </Animator>
                                </ScrollPage>
                            </ScrollContainer>
                            ...
                            <ScrollContainer>
                                <ScrollPage page={2}>
                                    <Animator animation={batch(Sticky(44, 55), Fade(), MoveOut(0, -200))}>
                                        ...
                                        My purpose is to add value to the world through my knowledge and skills as well as contribute to the creative solution of problems.
                                        </p>
