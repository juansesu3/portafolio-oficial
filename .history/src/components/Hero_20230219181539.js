                                ...
                                <ScrollPage page={2}>
                                    <Animator animation={batch(Sticky(36, 55), Fade(), MoveOut(0, -200))}>
                                        ...
                                        <p className='font-style2'>
                                            My purpose is to contribute with creative solutions to the problems 
                                            facing the technology industry and add value to the world through my knowledge and skills as a developer.
                                        </p>
