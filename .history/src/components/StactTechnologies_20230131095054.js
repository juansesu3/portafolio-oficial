 ...
 */
  ...
  return (
    <div style={{ backgroundColor: "#1d1d1d" }}>
      ...
      <br /><br /><br />
      <center><Button style={{outline:"none" backgroundColor: "#08fdd8", borde:"#08fdd8 1px solid" }} onClick={showMoreItems}><ASC  target="_blank" >Show More Technologies</ASC></Button></center>
    </div>
  )
}
