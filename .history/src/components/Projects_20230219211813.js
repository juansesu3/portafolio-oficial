...
import { IoLogoReact, IoLogoJavascript, IoLogoSass, IoLogoCss3, IoLogoFirebase } from "react-icons/io5"
                            ...
                            <Card key={project.id} style={{ width: '18rem', marginTop: '20px' }}>
                                ...
                                <ListGroup className="list-group-flush" style={{ backgroundColor: '#181818', color: 'white' }}>
                                    <ListGroup.Item style={{ backgroundColor: '#181818', color: 'white' }}>
                                        {project.technologies.map((techn)=>(                                         
                                         <p>{techn.iconName}</p>                                                                                   
                                        ))}
                                        </ListGroup.Item>
                                </ListGroup>
...
// como crear un componente despues de iterar un arreglo con .map?  
...
//Source: https://stackoverflow.com/questions/482697
