 ...
 */
  ...
  return (
    <div style={{ backgroundColor: "#1d1d1d" }}>
              ...
              return (
                ...
                <Card key={tech.idTech} style={{ width: '18rem', margin: '1rem' }}>
                  ...
                  <Card.Body style={{
                    ...
                    <Button style={{ backgroundColor: "#08fdd8", color: #1d1d1d; }}  ><ASC href={tech.urlToLearning} target="_blank" >Learn it</ASC></Button>
                  </Card.Body>
                </Card>
              );
            })}
      ...
      <br /><br /><br />
      <center><Button style={{ backgroundColor: "#08fdd8", }} onClick={showMoreItems}>Show More Technologies</Button></center>
    </div>
  )
}
