...
import { Anchor,  Fontlora, Textstyle, Tittle } from '../styles/Projects.styles'
                ...
                <ScrollContainer>
                    ...
                    {proyects.map((project) => (
                        <Card key={project.id} style={{ width: '18rem' }}>
                            ...
                            <Card.Body>
                                <Card.Link href={project.shortDescription}>Card Link</Card.Link>
                                <Card.Link href={project.shortDescription}>Another Link</Card.Link>
                            </Card.Body>
                        </Card>
                    ))}
                    <center>
