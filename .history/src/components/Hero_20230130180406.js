                            ...
                            <ScrollContainer>
                                ...
                                <ScrollPage page={1}>
                                    <Animator animation={batch(Sticky(35, 60), Fade(), MoveOut())}>
                                        ...
                                        <h¡Hi there! 👋🏻1></h1></span><br />
                                            <span className='font-style'>My name is<br />
                                            <span className='font-style2'> Juan Sebastian Suarez <br />I'm a front-end web developer with an emphasis on React.js</span>
                                            </span>
                                    </Animator>
                                </ScrollPage>
                            </ScrollContainer>
