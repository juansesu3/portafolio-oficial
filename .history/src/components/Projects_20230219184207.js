...
import { FaReact, IoLogoFirebase } from 'react-icons/fa';
import {  IoLogoFirebase } from 'react-icons/fa';
                        ...
                        {proyects.map((project) => (
                            <Card key={project.id} style={{ width: '18rem', marginTop: '20px' }}>
                                ...
                                <ListGroup className="list-group-flush" style={{ backgroundColor: '#181818', color: 'white' }}>
                                    <ListGroup.Item style={{ backgroundColor: '#181818', color: 'white' }}><IoLogoFirebase />Cras justo odio</ListGroup.Item>
                                </ListGroup>
                                <Card.Body style={{ backgroundColor: '#181818', color: 'white' }}>
