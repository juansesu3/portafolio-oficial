 ...
 */
  ...
  return (
    <div style={{ backgroundColor: "#1d1d1d" }}>
      ...
      <br /><br /><br />
      <center><Button style={{ outline: "none !important", backgroundColor: "#08fdd8", border: "#343a40" }} onClick={showMoreItems}><ASC target="_blank" >Show More Technologies</ASC></Button></center>
    </div>
  )
}
