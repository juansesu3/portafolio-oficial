 ...
 */
  ...
  return (
    <div style={{ backgroundColor: "#1d1d1d" }}>
      ...
      <br /><br /><br />
      <center><Button style={{ backgroundColor: "#08fdd8", color: "#1d1d1d"}} onClick={showMoreItems}><ASC href={tech.urlToLearning} target="_blank" >Learn it</ASC>Show More Technologies</Button></center>
    </div>
  )
}
