        ...
        <div>
            <Fontlora>
                <ScrollContainer>
                    ...
                    { proyects.slice(0, visible).map((proyec) =>{
                    ...
                    <center>
                        <Button style={{ outline: "none !important", backgroundColor: "#08fdd8", border: "#343a40" }} onClick={showMoreItems}><ASC target="_blank" >Show More Technologies</ASC></Button></center>
