                                ...
                                <ScrollPage page={1}>
                                    <Animator animation={batch(Sticky(35, 60), Fade(), MoveOut())}>
                                        <span className='font-style2'>
                                            ¡Hi there! 👋🏻</span><br /><span className='font-style'>My name is</span><br /><span className='font-style2'> Juan Sebastian Suarez <br />I'm a front-end web developer with an emphasis on React.js</span>
                                    </Animator>
                                </ScrollPage>
                            </ScrollContainer>
                        </H2>
