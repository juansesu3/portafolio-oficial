              ...
              return (
                ...
                <Card key={tech.idTech} style={{ width: '18rem', margin:'1rem'}}>
                  <Card.Img variant="top" src={tech.image}
                    alt="First slide" />
                  <Card.Body  style={{ backgroundColor:"#181818", borderLeft: "#08fdd8 2px solid",borderRight: "#08fdd8 2px solid", borderBottom:"#08fdd8 2px solid", borderTop-left-radius: 20px;}}>
